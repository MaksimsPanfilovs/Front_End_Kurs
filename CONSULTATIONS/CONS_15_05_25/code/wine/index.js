// 1. Отправить запрос на https://api.sampleapis.com/wines/whites и
// получить (вывести в консоль) массив с данными о белых винах
  ...
  array
    ...
    .forEach(({ image, wine, winery, rating }) => {
      ...
      cardElem.style.backgroundColor =
        rating.average > 4.8 ? "lightgreen" : "lightblue";
