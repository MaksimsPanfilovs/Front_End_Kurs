...
// убедится что мы действительно получили элемент в переменную, а не null
...
// innerText
// мы можем обратится к элементу -
// и обновить значение его свойства

// eventListener - слушатель событий - который будет вызывать
